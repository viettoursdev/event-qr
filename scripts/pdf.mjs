...
// đường dẫn ảnh QR theo đúng quy ước đặt tên ở qrcodes.mjs
const files = guests.map((g, i) => {
  const file = `${String(i + 1).padStart(3, "0")}_${safeName(g.name)}_${g.token}.png`;
  return p("private", "qr", file);
});
